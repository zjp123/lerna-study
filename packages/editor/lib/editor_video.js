...
class Video extends BlockEmbed {
  static create (value) {
    ...
    node.setAttribute('style', 'width: 300px; height:200px;');
    ...
    node.setAttribute('x5-video-player-type', 'h5-page'); // 启用H5播放器,是wechat安卓版特性
    ...
    node.setAttribute('object-fit', 'fill'); // 兼容 移动端平铺显示
